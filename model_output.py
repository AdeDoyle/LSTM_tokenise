...
from test_model import tokenise
...
if __name__ == "__main__":
    ...
    base_dir = os.getcwd()
    mods_dir = base_dir + "\\models\\models"
    os.chdir(mods_dir)
    ...
    for mod in allmods:
        ...
        save_docx(output, "models\\models\\output\\".join(model.split("models\\models\\")))
        print("    Complete!\n")
