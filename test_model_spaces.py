...
if __name__ == "__main__":
    ...
    model_1 = "models\\space_models\\Wb-spaces, 2x75 LSTMs, 1 Dense, 250 Ep, No Bat, 10.0% Val"
    ...
    model_2 = "models\\space_models\\Sg-spaces, 2x50 LSTMs, 1 Dense, 250 Ep, No Bat, 10.0% Val"
    ...
    #         model = f"models\\space_models\\{designation}-spaces, 2x{nodes} " \
